...
const TaskTable = ({ tasks }) => {
  ...
  const TableRow = ({ task }) => (
    <tr className='border-b border-gray-300 text-gray-600 hover:bg-gray-300/20'>
      {/* Task Title */}
      <td className='py-2'>
...
const UserTable = ({ users }) => {
  ...
  const TableRow = ({ user }) => (
    <tr className='border-b border-gray-200 text-gray-600 hover:bg-gray-300/20'>
      ...
      <td className='py-2 pl-4 text-sm'>{moment(user?.createdAt).fromNow()}</td>
    </tr>
  )
  return (
...
const Dashboard = () => {
    ...
    return (
      <div className='w-full h-32 bg-white p-5 shadow-md rounded-md flex items-center justify-between' >
        <div className='h-full flex flex-col justify-between'>
          <span className='text-white bg-gray-700 rounded-md font-semibold px-2 py-1 mb-1 text-center'>{label}</span>
          <span className='text-2xl font-semibold mt-1'>{count}</span>
          <span className='text-sm text-gray-400 mt-1'>{"110 last month"}</span>
        </div>
        <div
  ...
  return (
    <div className='h-full py-4'>
      ...
      <div className='w-full bg-white my-8 p-4 rounded-md shadow-lg'>
