...
import { MdDashboard, MdOutlineAdd, MdOutlineAddTask, MdOutlinePendingActions, MdSettings, MdTask, MdTaskAlt } from "react-icons/md"
        ...
        <div className='w-full h-full flex flex-col gap-6 p-5'>
            <h1 className='flex gap-1 items-center'>
                <p className='bg-blue-600 p-2 rounded-full'>
                    <MdOutlineAddTask className='text-slate-100 text-2xl font-black'/>
                </p>
            ...
            <div>
                <button className='w-full flex gap-2 p-2 items-center'>
                    <MdSettings />
                    <span>Settings</span>
                </button>
            </div>
